...
<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding:10px 60px 20px 60px">
    <form id="ff" class="easyui-form" method="post">
		<table cellpadding="5px;">
				<td><input  style="width:200px;height:22px" type="hidden"  name="id" value="${menu.id }"  /></td>
			<tr>
			...
			<tr>
				...
				<td><input class="easyui-textbox" style="width:200px;height:22px" type="text" name="url" value="${menu.url}" data-options="missingMessage:'资源路径'"/></td>
			</tr>
			<tr>
...
<!-- 			<td><select id="pid" name="pid" style="width: 140px; height: 29px;" data-options="missingMessage:'父节点'"></select></td> -->
				<td><input id="pid"  type="hidden" readonly="readonly" name="parentId" value="${menu.parentId}" />
					<input id="pname" class="easyui-textbox" type="text" style="width: 200px; height: 29px;" value="${menu.parentName}" readonly="readonly"  data-options="missingMessage:'父节点'"/></td>
			</tr>
			</c:if>
		</table>  
	</form> 
